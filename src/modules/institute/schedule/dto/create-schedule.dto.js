...
var CreateScheduleDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateScheduleDto() {
                ...
                this.dayOfWeek = (__runInitializers(this, _assignmentId_extraInitializers), __runInitializers(this, _dayOfWeek_initializers, void 0));
                this.startTime = (__runInitializers(this, _dayOfWeek_extraInitializers), __runInitializers(this, _startTime_initializers, void 0)); // "09:00"
                this.endTime = (__runInitializers(this, _startTime_extraInitializers), __runInitializers(this, _endTime_initializers, void 0)); // "10:20"
                this.room = (__runInitializers(this, _endTime_extraInitializers), __runInitializers(this, _room_initializers, void 0));
                __runInitializers(this, _room_extraInitializers);
            }
        ...
        (function () {
            ...
            _dayOfWeek_decorators = [(0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1), (0, class_validator_1.Max)(7)];
            _startTime_decorators = [(0, class_validator_1.IsString)()];
            _endTime_decorators = [(0, class_validator_1.IsString)()];
            _room_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
