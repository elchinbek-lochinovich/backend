...
var Faculty = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('faculties')];
    ...
    var Faculty = _classThis = /** @class */ (function () {
        function Faculty_1() {
    ...
    (function () {
        ...
        _name_decorators = [(0, typeorm_1.Index)({ unique: true }), (0, typeorm_1.Column)({ type: 'varchar', length: 150 })];
