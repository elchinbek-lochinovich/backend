...
var DepartmentController = function () {
    ...
    var DepartmentController = _classThis = /** @class */ (function () {
        function DepartmentController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        DepartmentController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        DepartmentController_1.prototype.findAll = function (facultyId) {
            return this.service.findAll(facultyId ? Number(facultyId) : undefined);
        };
        DepartmentController_1.prototype.findOne = function (id) {
            return this.service.findOne(id);
        };
        DepartmentController_1.prototype.update = function (id, dto) {
            return this.service.update(id, dto);
        };
        DepartmentController_1.prototype.remove = function (id) {
