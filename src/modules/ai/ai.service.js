...
var AiService = function () {
    ...
    var AiService = _classThis = /** @class */ (function () {
        ...
        AiService_1.prototype.runPrompt = function (prompt) {
            return __awaiter(this, void 0, void 0, function () {
                var model, response, text, err_1;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.client.chat.completions.create({
                                    ...
                                    messages: [
                                        {
                                            role: 'system',
                                            content: 'You are a strict JSON generator. Return ONLY valid JSON. No markdown, no text.',
                                        },
                                        {
                                            role: 'user',
                                            content: prompt,
                        ...
                        case 2:
                            err_1 = _c.sent();
                            throw new common_1.InternalServerErrorException('AI generation failed', err_1 === null || err_1 === void 0 ? void 0 : err_1.message);
