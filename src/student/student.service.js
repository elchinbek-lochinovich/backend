...
var StudentService = function () {
    ...
    var StudentService = _classThis = /** @class */ (function () {
        function StudentService_1(prisma) {
            this.prisma = prisma;
        }
        StudentService_1.prototype.getMe = function (userId) {
        ...
        StudentService_1.prototype.myAssignments = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var profile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            profile = _a.sent();
                            if (!(profile === null || profile === void 0 ? void 0 : profile.groupId))
                                return [2 /*return*/, []];
        ...
        StudentService_1.prototype.myAttendance = function (userId, from, to) {
            return __awaiter(this, void 0, void 0, function () {
                var fromDate, toDate;
                return __generator(this, function (_a) {
        ...
        StudentService_1.prototype.myGrades = function (userId, assignmentId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.grade.findMany({
                            where: {
                                studentUserId: userId,
                                assignmentId: assignmentId !== null && assignmentId !== void 0 ? assignmentId : undefined,
                            },
