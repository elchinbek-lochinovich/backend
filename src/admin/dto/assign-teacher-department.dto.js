...
exports.AssignTeacherDepartmentDto = void 0;
var class_validator_1 = require("class-validator");
var AssignTeacherDepartmentDto = function () {
    var _a;
    var _departmentId_decorators;
    var _departmentId_initializers = [];
    var _departmentId_extraInitializers = [];
    return _a = /** @class */ (function () {
            function AssignTeacherDepartmentDto() {
                this.departmentId = __runInitializers(this, _departmentId_initializers, void 0);
                __runInitializers(this, _departmentId_extraInitializers);
            }
            return AssignTeacherDepartmentDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _departmentId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)()];
...
exports.AssignTeacherDepartmentDto = AssignTeacherDepartmentDto;
