...
exports.AssignStudentGroupDto = void 0;
var class_validator_1 = require("class-validator");
var AssignStudentGroupDto = function () {
    var _a;
    var _groupId_decorators;
    var _groupId_initializers = [];
    var _groupId_extraInitializers = [];
    return _a = /** @class */ (function () {
            function AssignStudentGroupDto() {
                this.groupId = __runInitializers(this, _groupId_initializers, void 0);
                __runInitializers(this, _groupId_extraInitializers);
            }
            return AssignStudentGroupDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _groupId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)()];
...
exports.AssignStudentGroupDto = AssignStudentGroupDto;
