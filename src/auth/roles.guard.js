...
var RolesGuard = function () {
    ...
    var RolesGuard = _classThis = /** @class */ (function () {
        ...
        RolesGuard_1.prototype.canActivate = function (context) {
            ...
            var allowed = ((_a = this.reflector.get(exports.ROLES_KEY, handler)) !== null && _a !== void 0 ? _a : this.reflector.get(exports.ROLES_KEY, clazz)) || [];
            // agar roles qo'yilmagan bo'lsa — ruxsat (faqat JwtGuard tekshiradi)
            if (allowed.length === 0)
                return true;
            var req = context.switchToHttp().getRequest();
            var role = (_b = req.user) === null || _b === void 0 ? void 0 : _b.role;
            if (!role)
